  ...
  return (
    <div className="flex flex-col md:flex-row p-4 md:p-16 items-center">
      <div className="w-full md:w-2/3 mb-8 md:mb-0 md:mr-4">
        <h1 className="text-4xl md:text-8xl leading-none hover:text-5xl md:hover:text-9xl transition-all ease-in-out">
        ...
        <div className="flex flex-col">
          ...
          <ul className="text-zinc-600 font-semibold gap-2 flex flex-wrap">
            {social.map((item, index) => (
              <li
                className="cursor-pointer hover:pl-2 transition-all ease-in-out"
                key={index}
              >
                {item}
              </li>
